...
const IconBellOutlineArtwork = ({ size = 16, className, strokeWidth }: WeightedIconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" strokeWidth={strokeWidth}>
    <path
...
/** Regular one-pixel IconBellOutline artwork for the session-completion notification entry point. */
export const IconBellOutlineRegular = (props: IconProps) => (
  <IconBellOutlineArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconBellOutline artwork with a 1.3px stroke. */
export const IconBellOutlineMedium = (props: IconProps) => (
  <IconBellOutlineArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
